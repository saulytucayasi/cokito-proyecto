...
@section('title', 'Cursos - COKITO+ Academia')
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6;">
                            ...
                            <td style="padding: 0.75rem;">
                                <a href="{{ route('secretaria.cursos.show', $curso->id) }}" class="btn btn-sm btn-info">Ver</a>
                                {{-- <a href="{{ route('secretaria.cursos.edit', $curso->id) }}" class="btn btn-sm btn-warning">Editar</a> --}}
                                {{-- <form action="{{ route('secretaria.cursos.destroy', $curso->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
