...
class MaterialController extends Controller
{
    public function index()
    {
        ...
        return view('secretaria.materiales.index', compact('materiales'));
    }

    public function create()
    {
        $cursos = Curso::all();
        return view('secretaria.materiales.create', compact('cursos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('secretaria.materiales.index')
                         ->with('success', 'Material creado exitosamente.');
    }

    public function show(Material $material)
    {
        return view('secretaria.materiales.show', compact('material'));
    }

    public function edit(Material $material)
    {
        $cursos = Curso::all();
        return view('secretaria.materiales.edit', compact('material', 'cursos'));
    }
